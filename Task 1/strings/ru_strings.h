...
static const char *APP_STR_TITLE =
    "ТИ, лабораторная работа 1 (вариант 7)";
...
static const char *APP_STR_FILE_OPEN_DIALOG_TITLE =
    "Выберите файл для считывания текста";
static const char *APP_STR_FILE_OPEN_DIALOG_FILTER_TXT =
    "Текстовые файлы (*.txt)";

static const char *APP_STR_FILE_SAVE_DIALOG_TITLE =
    "Выберите место для сохранения файла с итоговым текстом";
// END
